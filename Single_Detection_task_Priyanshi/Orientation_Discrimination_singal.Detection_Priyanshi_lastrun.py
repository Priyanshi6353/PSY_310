...
expName = 'Orientation_Discrimination_singal.Detection_Priyanshi'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\OneDrive\\Single_Detection_task_Priyanshi\\Orientation_Discrimination_singal.Detection_Priyanshi_lastrun.py',
